<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2 text-uppercase">WareHouse</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <?php if (session()->get('user.role') === "Superuser") : ?>
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text">Preferences</span>
            </li>
            <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class='menu-icon tf-icons bx bx-cog'></i>
                    <div data-i18n="Layouts">Preferences</div>
                </a>
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="layouts-without-navbar.html" class="menu-link">
                            <div data-i18n="Without navbar">Access Menu</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="layouts-container.html" class="menu-link">
                            <div data-i18n="Container">Access Level</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="layouts-fluid.html" class="menu-link">
                            <div data-i18n="Fluid">Permission</div>
                        </a>
                    </li>
                </ul>
            </li>
